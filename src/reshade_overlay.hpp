...
struct imgui_function_table
{
	...
	/*void (*ClearTexData)(const ImFontAtlas* _this);
	ImFont* (*AddFontFromMemoryTTF)(const ImFontAtlas* _this, void* ttf_data, int ttf_size, float size_pixels, const ImFontConfig* font_cfg_template, const ImWchar* glyph_ranges);
	void (*AddFont)(const ImFontAtlas* _this, const ImFontConfig* font_cfg);
	const ImWchar* (*GetGlyphRangesChineseFull)(const ImFontAtlas* _this);*/
};
...
namespace ImGui
{
	...
	{
		return imgui_function_table_instance()->InputText(label, str,  flags, callback, user_data); 
	}*/
...
//inline const ImWchar* ImFontAtlas::GetGlyphRangesChineseFull(ImFontAtlas* _this)
//{
//	return imgui_function_table_instance()->GetGlyphRangesChineseFull(_this);
//}
//
//inline void ImFontAtlas::ClearTexData(const ImFontAtlas* _this)
//{
//	imgui_function_table_instance()->ClearTexData(_this);
//}
//
//inline void ImFontAtlas::AddFont(const ImFontAtlas* _this, const ImFontConfig* font_cfg)
//{
//	imgui_function_table_instance()->AddFont(_this, font_cfg);
//}
//
//inline ImFont* ImFontAtlas::AddFontFromMemoryTTF(const ImFontAtlas* _this, void* ttf_data, int ttf_size, float size_pixels, const ImFontConfig* font_cfg = NULL, const ImWchar* glyph_ranges = NULL)
//{
//	return imgui_function_table_instance()->AddFontFromMemoryTTF(_this, ttf_data, ttf_size, size_pixels, font_cfg, glyph_ranges);
//}
